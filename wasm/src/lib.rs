...
#[wasm_bindgen]
impl Particle {
    pub fn new(width: f64, height: f64, fade_speed: f64, opacity: f64) -> Particle {
        Particle {
...
impl ParticleSystem {
    ...
    pub fn new(canvas_id: &str, fade_speed: f64) -> ParticleSystem {
        ...
        let particles = (0..100)
            .map(|i| {
                let fade = if i % 2 == 0 { fade_speed } else { -fade_speed };
                Particle::new(
                    canvas.width() as f64,
